  ...
  return (
    <section className=" relative w-full overflow-hidden py-20 md:py-28 bg-gradient-deep flex flex-col items-center text-center">
      ...
      <Dice2
        ...
        strokeWidth={1.5}
      />
      <div className="bg-deep-purple-500 rotate-180 shadow-sm h-25 w-25 rounded-2xl absolute top-30 left-30"></div>

      <Dice1
        className="absolute z-1 top-60 right-[-150] text-purple-400/20 w-40 h-40 md:w-70 md:h-70 rotate-90"
        strokeWidth={1.5}
      />
